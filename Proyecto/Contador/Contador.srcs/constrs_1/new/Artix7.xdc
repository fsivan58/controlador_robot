...
set_property PACKAGE_PIN N12 [get_ports s0]
set_property PACKAGE_PIN R12 [get_ports s1]
set_property PACKAGE_PIN R13 [get_ports s2]
set_property PACKAGE_PIN P14 [get_ports s3]
...
set_property PACKAGE_PIN P13 [get_ports serial_color]
set_property IOSTANDARD LVCMOS33 [get_ports serial_color]

set_property PACKAGE_PIN B7 [get_ports sw1]
set_property IOSTANDARD LVCMOS33 [get_ports sw1]

set_property IOSTANDARD LVCMOS33 [get_ports de_l]
set_property PACKAGE_PIN T13 [get_ports de_l]